...
class ChangeAgendaComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            mileStone: [],
    ...
    componentDidMount = () => {
        ...
        this.setState({
            ...
            mileStone: !isEmpty(params.params.milestone) ? params.params.milestone : []
        });
    }
    ...
    _onSaveData = () => {
        ...
        if (!isEmpty(this.state.name) || !isEmpty(this.state.content)) {
            ...
            this.props.onfetchUpdateAgenda(param);
...
export default ChangeAgendaComponent;